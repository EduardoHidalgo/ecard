...
export default function LegalPage() {
  return (
    <>
      <HeaderSection onlyLogo />
      <div className="flex flex-col gap-6 my-32 max-w-4xl mx-auto px-6 sm:px-0">
        ...
        <h1 className="font-medium text-lg">2. CREDIT CARD DETAILS</h1>
        <p>
        ...
        <h1 className="font-medium text-lg">3. LEGAL ADVICE</h1>
        <p>
        ...
        <h1 className="font-medium text-lg">4. CHANGE OF USE</h1>
        ...
        <h1 className="font-medium text-lg">6. COPYRIGHT</h1>
        <ul>
          <li>
        ...
        <ul>
          ...
          <ol type="A">
            ...
            <li>
              You do not misrepresent your relationship with this app; and
            </li>
            <li>
              The app from which you link to this app does not contain offensive
              or otherwise controversial content or, content that infringes any
        ...
        <h1 className="font-medium text-lg">9. INDEMNITY</h1>
        <p>
        ...
        <h1 className="font-medium text-lg">10. SEVERANCE</h1>
        <p>
        ...
        <h1 className="font-medium text-lg">11. WAIVER</h1>
        <p>
        ...
        <h1 className="font-medium text-lg">12. GOVERNING LAW</h1>
        <p>
          These Terms and Conditions shall be governed by and construed in
          accordance with the law of and you hereby submit to the exclusive
          jurisdiction of the courts.
        </p>
        <h1 className="font-medium text-lg">13. OUR CONTACT DETAILS</h1>
        <p>
          Our Support Address:{" "}
          <Link href={"https://dedalomultimedia.com"}>
            https://dedalomultimedia.com
          </Link>
        </p>
      </div>
      <FooterSection />
